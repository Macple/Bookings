...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	<strong>Reservation Confirmation</strong><br>
	Dear Owner, <br>
	This is to confirm the reservation from %s to %s. <br>
	Reserved for: %s %s <br>
	Phone: %s <br>
	Email: %s <br>
	`, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"), reservation.FirstName, reservation.LastName, reservation.Phone, reservation.Email)
...
func (m *Repository) Logout(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "warning", "Logged out!")
	http.Redirect(w, r, "/user/login", http.StatusSeeOther)
}
...
// AdminPostShowReservation posts edited reservation
...
// AdminPostReservationsCalendar handles POST of reseration calendar
